...
# вызываем метод данного объекта. Метод автоматически делает каждую первую букву слова заглавной
print(name.capitalize())
print(name.upper())
# print(dir(name))
'''
Ответ: ['__add__', '__class__', '__contains__', '__delattr__', '__dir__', '__doc__', '__eq__', '__format__',
...
my_list = [1, 2, 3]
print(my_list)
# форматирование кода Shift+Option+F

# а
# а
# а
# а
# а многострочный коммент Command+/
